#ifndef __IPlugMIDIPassThru__
#define __IPlugMIDIPassThru__
...
class IPlugMIDIPassThru : public IPlug
{
public:

  IPlugMIDIPassThru(IPlugInstanceInfo instanceInfo);
  ~IPlugMIDIPassThru();
...
private:
  ...
  MIDIPortRef mMIDIPort;
  MIDIEndpointRef mMIDIEndPoint;
};
